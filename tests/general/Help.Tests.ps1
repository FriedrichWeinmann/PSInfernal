...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSInfernal\functions", "$global:testroot\..\PSInfernal\internal\functions"),
	
	[string]
	$ModuleName = "PSInfernal",
...
$CommandPath = @(
    "$global:testroot\..\PSInfernal\functions"
    "$global:testroot\..\PSInfernal\internal\functions"
)
