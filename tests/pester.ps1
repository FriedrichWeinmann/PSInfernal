...
Remove-Module PSInfernal -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSInfernal\PSInfernal.psd1"
Import-Module "$PSScriptRoot\..\PSInfernal\PSInfernal.psm1" -Force
